...
export type { Dwa } from "./contracts/Dwa";
export { Dwa__factory } from "./factories/contracts/Dwa__factory";
export type { DwaV2 } from "./contracts/DwaV2";
export { DwaV2__factory } from "./factories/contracts/DwaV2__factory";
